-- =====================================================================
-- 0017  Sold parts carry their date, and the newest sale comes first
--
-- Turn "Including sold" on and the list came back ordered by when the
-- part row was created -- which is when its car was booked in, not when
-- anybody bought anything. So a transmission sold this morning sat below
-- a gear shift cover sold in March, and no row said which was which,
-- because a sale date was never returned at all.
--
-- Three things follow from that: the date comes back, it can be filtered
-- on, and with nothing typed in the box the most recent sale leads.
-- =====================================================================
